...
def diagrama_divisor():
    ...
    s.write(txt(480, 62, "esta é a ordem da serigrafia, que", 11.5, C["rx"], "700", "start"))
    s.write(txt(480, 80, "fica no verso. Vista de cima, a", 11.5, C["rx"], "700", "start"))
    s.write(txt(480, 98, "plaquinha espelha: VCC vem antes.", 11.5, C["rx"], "700", "start"))
    s.write(txt(480, 124, "os dois DATA são o mesmo ponto por", 11.5, C["fraco"], "600", "start"))
    s.write(txt(480, 142, "dentro: use um, deixe o outro livre.", 11.5, C["fraco"], "600", "start"))
